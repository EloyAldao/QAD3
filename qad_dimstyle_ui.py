...
class Ui_DimStyle_Dialog(object):
    ...
    def retranslateUi(self, DimStyle_Dialog):
        ...
        self.SetCurrent.setToolTip(_translate("DimStyle_Dialog", "Sets the style selected under Styles to current. The current style is applied to dimensions you\n"
"                    create.\n"
"                "))
        ...
        self.TempMod.setToolTip(_translate("DimStyle_Dialog", "Set temporary modifications for the selected style. The temporary modifications will not\n"
"                    saved.\n"
"                "))
