...
class Ui_DimStyle_Diff_Dialog(object):
    ...
    def retranslateUi(self, DimStyle_Diff_Dialog):
        ...
        self.dimStyle2.setToolTip(_translate("DimStyle_Diff_Dialog", "Specify the second dimension style. If you set the second style as the first, all dimension\n"
"                    style properties will displayed.\n"
"                "))
        ...
        self.tableWidget.setToolTip(_translate("DimStyle_Diff_Dialog", "<html><head/><body><p>Display the result of comparing dimension\n"
"                    styles.If you compare two different styles, the settings that are different between the two\n"
"                    dimension styles, their current settings, and brief descriptions are listed. If you set the second\n"
"                    style as the first, all dimension style properties will displayed.</p></body></html>\n"
"                "))
